...
<link rel="stylesheet" href="main.css">
			<div class="header">
				<ul>
					<li style="float:left;border-right:none"><a href="mainpage.php" class="logo"><img src="images/LOGO.png" width="20px" height="20px"><strong> M.O.S.H. </strong>Medical Online Scheduling Helper</a></li>
