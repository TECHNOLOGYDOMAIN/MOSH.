...
<body style="background-image:url(images/signup.png)">
<div class="header">
				<ul>
				<li style="float:left;border-right:none"><a href="signup.php" class="logo"><img src="images/LOGO.png" width="30px" height="30px"><strong> M.O.S.H. </strong>Medical Online Scheduling Helper</a></li>
