...
<!DOCTYPE html>
<html>
<body style="background-image:(images/cover.png)">
<link rel="stylesheet" href="main.css">
			<div class="header">
				<ul>
					<li style="float:left;border-right:none"><a href="mainpage.php" class="logo"><img src="LOGO.png" width="20px" height="20px"><strong> M.O.S.H. </strong>Medical Online Scheduling Helper</a></li>
...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" method="post" action="mainpage.php">
